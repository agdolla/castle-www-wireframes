...
const STYLES_TOPIC = css`
  ...
  background-image: linear-gradient(315deg, #ff00ff 0%, #d000d0 74%);
`;
    ...
    return (
      <div className={STYLES_ROOT}>
        <div className={STYLES_ROOT_LEFT}>
          <header className={STYLES_HEADING}>
            <div className={STYLES_HEADING_LEFT}>
              <span className={STYLES_BRAND}>Castle</span>
              <span className={STYLES_LINK}>Tutorials</span>
              <span className={STYLES_LINK}>News</span>
              <span className={STYLES_LINK}>Reviews</span>
              <span className={STYLES_LINK}>Documentation</span>
            </div>
            <div className={STYLES_HEADING_RIGHT}>
              <span
                className={STYLES_AVATAR}
                style={{ backgroundImage: `url(/static/avatar-login.png)` }}
              />
              <span className={STYLES_LINK} style={{ marginRight: 0, marginLeft: 24 }}>
                Edit
              </span>
            </div>
          </header>
          <div className={STYLES_TOPIC}>News</div>
          <div className={STYLES_LAYOUT}>
            ...
            <div className={STYLES_BYLINE}>
              ...
              <span className={STYLES_BYLINE_TEXT}>
                <strong>Tiffany Zhong</strong> — August 14th, 2019 — Posted in <a href="#">News</a>
              </span>
            </div>
            <div>
              <ReactMarkdown
